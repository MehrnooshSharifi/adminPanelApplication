...
export default async function handler(req, res) {
  ...
  const { email, phoneNumber, nationalCode, adminId, isActiveAdmin, roleType } =
    req.body;
  ...
  try {
    const url = `${process.env.NEXT_PUBLIC_CLIENT_URL}/USR/api/v1/UserManagement/AdminUser/UpdateRoleType`;
