...
export default async function handler(req, res) {
  ...
  try {
    const url = `${process.env.NEXT_PUBLIC_CLIENT_URL}/USR/api/v1/UserManagement/PublicAppAssignUser/ResetApplicationPass`;
    ...
    if (!response.ok) {
      ...
      return res
        ...
        .json({ message: "Failed to reset password", error: errorData });
    }
