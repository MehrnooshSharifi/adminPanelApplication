...
const EditServiceGroupTabletForm = ({
  formik,
  PrivateHandler,
  publicHandler,
  nonActiveHandler,
    ...
    >
      <div className="flex gap-x-[25px] lg:gap-x-[40px]">
        ...
        <div className="flex flex-col relative">
          <label
            className=" md:w-[117.11px] md:h-[20px] lg:w-[136px] lg:h-[20px] absolute -top-3  [5px] px-[10px] whitespace-nowrap mr-2 bg-naturalColor-2 flex flex-col text-[14px] lg:text-[16px] lg:-top-4 font-bold text-neutralColor-2"
      ...
      <div className="flex flex-col relative z-0 ">
        ...
        />
        <div
          className="w-fit h-[120px] absolute top-[15px] right-[640px] lg:right-[795px] lg:top-[20px] cursor-pointer"
...
export default EditServiceGroupTabletForm;
