  ...
  return (
    <div className="flex flex-col gap-y-[70px] items-center">
      ...
      >
        ...
        <button
          type="submit"
          className="bg-primaryColor-1  rounded-[5px] text-center   px-[16px] text-naturalColor-2 text-[16px] font-medium  w-[680px] h-[48px] lg:w-[157px] lg:h-[44px] lg:text-[16px]  lg:mt-[400px] lg:mr-[680px]  mt-[80px]"
        >
          ثبت تغییرات
        </button>
        {/* openIsActiveSection */}
...
export default TabletUpdateUserService;
